 ...
 * @param {Boolean} [options.collapseOnBlur=true] If true, the geocoder control will collapse the dropdown menu when the input blurs.
 ...
 * @param {Boolean} [options.hideResultsOnBlur=true] If `true`, the geocoder will hide the results when focus is lost. If `false`, the results will remain visible if focus is lost (i.e. scrolling with the map).
 * @example
...
MapboxGeocoder.prototype = {
  ...
  onAdd: function(map) {
    ...
    this._typeahead = new Typeahead(this._inputEl, [], {
      ...
      hideOnBlur: this.options.hideResultsOnBlur
    });
  ...
  _onBlur: function(e) {
    ...
    if (this.options.collapseOnBlur && this.options.collapsed) {
      this._collapse();
    }
  },
  _onChange: function() {
